...
class UserController extends Controller
{
    ...
    {
        $users = User::all();
        return view('managment.user')->with('users', $users);
    }
    ...
    {
        return view('managment.createUser');
    }
    ...
    {
        $request->validate([
            'name' => 'required|unique:users|max:2525',
            'email' => 'required|email|unique:users|max:2525',
    ...
    {
        $user = User::find($id);
        return view('managment.editUser')->with('user', $user);
    }
    ...
    {
        $request->validate([
            'name' => 'required|max:2525',
            'email' => 'required|email|max:2525',
            'password' => 'required|min:6|',
            'role' => 'required',
        ]);
        $user = User::find($id);
