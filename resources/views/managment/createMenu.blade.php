...
<div class="container">
    <div class="row justify-content-center">
        ...
        @endif
        <form action="/managment/menu" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <label for="menuPrice">Price</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                       ...
                       <input type="text" name="price" class="form-control" aria-label="Amout (to the nearest dollar)">
